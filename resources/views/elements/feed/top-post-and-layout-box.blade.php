<div class="feed-top-container">
    ...
    <div class="tabs-and-layout d-flex justify-content-between bg-white align-items-center feed-top-dfrt-sec">
        <div class="option-categery d-flex justify-content-between">
            <div class="hot-posts">
                <a class="posts_top_nav {{ Route::currentRouteName() == 'feed.hotFeed' ? 'active' : '' }}" href="{{route('feed.hotFeed')}}"><i class="fa fa-compass" aria-hidden="true"></i>
Explorer</a>
            </div>
            <div class="new-posts">
                <a class="posts_top_nav {{ Route::currentRouteName() == 'feed' ? 'active' : '' }}" href="{{route('feed')}}"><i class="fa fa-gratipay" aria-hidden="true"></i>
My Interest's</a>            
            </div>
            <div class="top-posts">
                
                <a class="posts_top_nav {{ Route::currentRouteName() == 'feed.followedPeople' ? 'active' : '' }}" href="{{route('feed.followedPeople')}}"><i class="fa fa-users" aria-hidden="true"></i>
