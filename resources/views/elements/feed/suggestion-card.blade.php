<div class="suggestion-box card text-white mb-2 border-0 rounded suggestion-swiper-slider" data-memberuserid="{{$profile->id}}">
    <div style="background: url({{$profile->cover}});" class="card-img suggestion-header-bg"></div>
    <div class="card-img-overlay p-0 swiper-slider-overlay">
        <!--<div class="h-100 w-100 p-0 m-0 position-absolute z-index-0 suggestion-position-set">-->
        <!--    <div class="h-50">-->
        <!--    </div>-->
        <!--    <div class="h-50 w-100 half-bg d-flex"></div>-->
        <!--</div>-->
        <div class="card-text w-100 h-100 d-flex suggestion-box-flex">

            <div class="d-flex align-items-center justify-content-center px-3 z-index-3 post-swiper-slider-avtar">
                <img class='swiper-avtar' src="{{$profile->avatar}}" class="avatar rounded-circle"  />
            </div>

            <div class="w-100 z-index-3 text-truncate swiper-description">
                ...
                <div class="h-50 w-100 z-index-3 d-flex flex-column justify-content-center text-truncate pr-2 suggestion-user-name">
