           ...
           <div class="follow-chat d-flex follow-chat-flex-wrapper">
               ...
               <div class="follow-wrapper">
                @if($hasSub || $viewerHasChatAccess)
                    <span class="p-pill ml-2 pointer-cursor" data-toggle="tooltip" data-placement="top" title="{{__('Send a message')}}" onclick="messenger.showNewMessageDialog()">Chat</span>
                @else
                    <span class="p-pill ml-2 pointer-cursor" data-toggle="tooltip" data-placement="top" title="{{__('DMs unavailable without subscription')}}">Chat</span>
                @endif
            </div>
        </div>
               {{-- <div class="bg-separator border-top border-bottom"></div> --}}
