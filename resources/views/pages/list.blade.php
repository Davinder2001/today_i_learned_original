...
@section('content')
    <div class="row suggestion-wraper-list-inner">
        <div class="min-vh-100 border-right col-12 pr-md-0 suggestion-wraper-list-insider">
            <div class="pt-4 pl-4 px-3 d-flex justify-content-between pb-3 border-bottom suggestion-wraper-list-top">
            ...
            <div class="mx-4 pt-2 suggestion-wraper-list-inner-bottom">
                <div class="list-wrapper mt-2">
                    <div class='feed-suggession-card sidebar-lists-suggession'>
                    @if(count($list->members))
                        <div class="row suggestion-followed-lists">
