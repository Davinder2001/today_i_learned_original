    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mb-4 mx-auto text-center">
                ...
                <a href="{{ url('/pages/about-us') }}" class="text-dark-r text-hover text-lg m-2">
                    {{__('About Us')}}
                </a>
                <a href="{{ url('/pages/content-policy') }}" class="text-dark-r text-hover text-lg m-2">
                    {{__('Content Policy')}}
                </a>
            ...
            <div class="col-lg-8 mx-auto text-center mb-3 mt-2">
                <div class="d-flex justify-content-center">
                    ...
                    @if(getSetting('social-media.telegram_link'))
                        <a class="m-2" href="{{getSetting('social-media.telegram_link')}}" target="_blank">
                            @include('elements.icon',['icon'=>'paper-plane','variant'=>'medium','classes' => 'text-lg opacity-8'])
                        </a>
                    @endif
                    @if(getSetting('social-media.reddit_url'))
                        <a class="m-2" href="{{getSetting('social-media.reddit_url')}}" target="_blank">
        ...
        <div class="row">
            <div class="col-8 mx-auto text-center mt-1">
                <p class="mb-0">
                    {{_("Copyright")}} © {{date('Y')}} {{getSetting('site.name')}}. {{_('All rights reserved.')}}
                </p>
